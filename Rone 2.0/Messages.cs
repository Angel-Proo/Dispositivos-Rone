...
namespace Rone_2._0
{
    ...
    {//campos
        private Color primaryColor = Color.FromArgb(64,64,64);
        ...
        public Messages(string text, string caption)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public Messages(string text, string caption, MessageBoxButtons buttons)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public Messages(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        public Messages(string text, string caption, MessageBoxButtons buttons, MessageBoxIcon icon, MessageBoxDefaultButton defaultButton)
        {
            InitializeComponent();
            InitializeItems();
            this.PrimaryColor = primaryColor;
        ...
        private void InitializeItems()
        {
            ...
            this.labelMessage.MaximumSize = new Size(550, 100);
        ...
        {
            int widht = this.labelMessage.Width
                + this.pictureBoxIcon.Width
                + this.panelButtons.Padding.Left;
            int height = this.panelTitleBar.Height + this.labelMessage.Height + this.panelBody.Height + this.panelButtons.Padding.Top;
            Size = new Size(widht, height);
        }
        private void SetButtons(MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            int xCenter = (this.panelBody.Width - button1.Width) / 2;
            int yCenter = (this.panelBody.Height - button1.Height) / 2;
            switch (buttons)
            {
        ...
        private void SetIcon(MessageBoxIcon icon)
        {
            switch (icon)
            {
                ...
                case MessageBoxIcon.None: //None
                    this.pictureBoxIcon.Image = Properties.Resources.check;
                    PrimaryColor = Color.LightSeaGreen;
                    break;
            }
        }
        //-> Events Methods
